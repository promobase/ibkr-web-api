...
class CalendarRequest(BaseModel):
    ...
    CalendarRequest
    """ # noqa: E501
    var_date: Optional[CalendarRequestDate] = Field(default=None, alias="date")
    filters: Optional[CalendarRequestFilters] = None
    __properties: ClassVar[List[str]] = ["date", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": CalendarRequestDate.from_dict(obj["date"]) if obj.get("date") is not None else None,
            "filters": CalendarRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
