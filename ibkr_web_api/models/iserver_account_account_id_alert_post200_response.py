...
class IserverAccountAccountIdAlertPost200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["request_id", "order_id", "success", "text", "order_status", "warning_message"]
