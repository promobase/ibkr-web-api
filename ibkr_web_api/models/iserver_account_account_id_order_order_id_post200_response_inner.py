...
class IserverAccountAccountIdOrderOrderIdPost200ResponseInner(BaseModel):
    """
    IserverAccountAccountIdOrderOrderIdPost200ResponseInner
    """ # noqa: E501
    order_id: Optional[StrictStr] = None
    local_order_id: Optional[StrictStr] = None
    order_status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["order_id", "local_order_id", "order_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "local_order_id": obj.get("local_order_id"),
