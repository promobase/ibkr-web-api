...
class TrsrvFuturesGet200Response(BaseModel):
    """
    TrsrvFuturesGet200Response
    """ # noqa: E501
    symbol: Optional[List[FuturesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "symbol": [FuturesInner.from_dict(_item) for _item in obj["symbol"]] if obj.get("symbol") is not None else None
        })
        return _obj
