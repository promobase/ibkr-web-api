...
class IserverSecdefStrikesGet200Response(BaseModel):
    """
    IserverSecdefStrikesGet200Response
    """ # noqa: E501
    call: Optional[List[StrictStr]] = None
    put: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["call", "put"]
