...
class AllocationInnerAssetClass(BaseModel):
    """
    portfolio allocation by asset class
    """ # noqa: E501
    long: Optional[AllocationInnerAssetClassLong] = None
    short: Optional[AllocationInnerAssetClassShort] = None
    __properties: ClassVar[List[str]] = ["long", "short"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "long": AllocationInnerAssetClassLong.from_dict(obj["long"]) if obj.get("long") is not None else None,
            "short": AllocationInnerAssetClassShort.from_dict(obj["short"]) if obj.get("short") is not None else None
        })
        return _obj
