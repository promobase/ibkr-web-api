...
class IserverAccountAccountIdAlertActivatePost200Response(BaseModel):
    """
    ...
    failure_list: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["request_id", "order_id", "success", "text", "order_status", "failure_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failure_list": obj.get("failure_list")
        })
        return _obj
