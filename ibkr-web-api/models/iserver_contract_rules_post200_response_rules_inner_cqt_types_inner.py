...
class IserverContractRulesPost200ResponseRulesInnerCqtTypesInner(BaseModel):
    """
    IserverContractRulesPost200ResponseRulesInnerCqtTypesInner
    """ # noqa: E501
    var_0: Optional[StrictStr] = Field(default=None, description="order types that support cash quantity trades", alias="0")
