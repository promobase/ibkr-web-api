...
class PortfolioAccountIdLedgerGet200Response(BaseModel):
    """
    PortfolioAccountIdLedgerGet200Response
    """ # noqa: E501
    base: Optional[Ledger] = Field(default=None, alias="BASE")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "BASE": Ledger.from_dict(obj["BASE"]) if obj.get("BASE") is not None else None
        })
        return _obj
