...
class IserverMarketdataUnsubscribeallGet200Response(BaseModel):
    """
    IserverMarketdataUnsubscribeallGet200Response
    """ # noqa: E501
    confirmed: Optional[StrictBool] = Field(default=None, description="true means market data is cancelled, false means it is not.")
    __properties: ClassVar[List[str]] = ["confirmed"]
