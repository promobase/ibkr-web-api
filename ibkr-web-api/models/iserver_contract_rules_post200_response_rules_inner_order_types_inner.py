...
class IserverContractRulesPost200ResponseRulesInnerOrderTypesInner(BaseModel):
    """
    IserverContractRulesPost200ResponseRulesInnerOrderTypesInner
    """ # noqa: E501
    var_0: Optional[StrictStr] = Field(default=None, description="list of available order types", alias="0")
