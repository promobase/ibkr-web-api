...
class IserverScannerParamsGet200ResponseLocationTreeInner(BaseModel):
    """
    IserverScannerParamsGet200ResponseLocationTreeInner
    """ # noqa: E501
    display_name: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    locations: Optional[List[IserverScannerParamsGet200ResponseLocationTreeInnerLocationsInner]] = None
    __properties: ClassVar[List[str]] = ["display_name", "type", "locations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "locations": [IserverScannerParamsGet200ResponseLocationTreeInnerLocationsInner.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None
        })
        return _obj
