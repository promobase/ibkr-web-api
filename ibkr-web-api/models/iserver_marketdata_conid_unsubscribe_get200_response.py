...
class IserverMarketdataConidUnsubscribeGet200Response(BaseModel):
    """
    IserverMarketdataConidUnsubscribeGet200Response
    """ # noqa: E501
    confirmed: Optional[StrictStr] = Field(default=None, description="success means market data was cancelled.")
