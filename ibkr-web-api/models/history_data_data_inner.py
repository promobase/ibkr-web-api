...
class HistoryDataDataInner(BaseModel):
    """
    ...
    v: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="volume")
    t: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="unix time stamp")
    __properties: ClassVar[List[str]] = ["o", "c", "h", "l", "v", "t"]
