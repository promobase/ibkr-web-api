...
class FyiDeliveryoptionsDevicePostRequest(BaseModel):
    """
    FyiDeliveryoptionsDevicePostRequest
    """ # noqa: E501
    devicename: Optional[StrictStr] = None
    device_id: Optional[StrictStr] = Field(default=None, alias="deviceId")
    ui_name: Optional[StrictStr] = Field(default=None, alias="uiName")
    enabled: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["devicename", "deviceId", "uiName", "enabled"]
