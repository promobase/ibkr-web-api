...
class AllocationInnerGroup(BaseModel):
    """
    portfolio allocation by group
    """ # noqa: E501
    long: Optional[AllocationInnerGroupLong] = None
    short: Optional[AllocationInnerGroupShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "long": AllocationInnerGroupLong.from_dict(obj["long"]) if obj.get("long") is not None else None,
            "short": AllocationInnerGroupShort.from_dict(obj["short"]) if obj.get("short") is not None else None
        })
        return _obj
