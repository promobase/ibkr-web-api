...
class StocksInnerContractsInner(BaseModel):
    """
    StocksInnerContractsInner
    """ # noqa: E501
    conid: Optional[StrictInt] = Field(default=None, description="conid of the stock contract")
    exchange: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["conid", "exchange"]
