...
class IserverAccountAccountIdOrderWhatifPost200ResponseAmount(BaseModel):
    """
    IserverAccountAccountIdOrderWhatifPost200ResponseAmount
    """ # noqa: E501
    amount: Optional[StrictStr] = Field(default=None, description="for example 23,000 USD")
    commission: Optional[StrictStr] = Field(default=None, description="for example 1.1 ... 1.2 USD")
    total: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["amount", "commission", "total"]
