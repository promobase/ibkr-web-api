...
class ScannerResultContractsContractInner(BaseModel):
    """
    ScannerResultContractsContractInner
    """ # noqa: E501
    in_scan_time: Optional[StrictStr] = Field(default=None, alias="inScanTime")
    distance: Optional[StrictInt] = None
    contract_id: Optional[StrictInt] = Field(default=None, alias="contractID")
    __properties: ClassVar[List[str]] = ["inScanTime", "distance", "contractID"]
