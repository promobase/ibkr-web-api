...
class StocksInner(BaseModel):
    """
    future contract information
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="company name")
    chinese_name: Optional[StrictStr] = Field(default=None, description="company name in Chinese", alias="chineseName")
    asset_class: Optional[StrictStr] = Field(default=None, alias="assetClass")
    contracts: Optional[List[StocksInnerContractsInner]] = Field(default=None, description="array of contracts from different exchanges")
    __properties: ClassVar[List[str]] = ["name", "chineseName", "assetClass", "contracts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contracts": [StocksInnerContractsInner.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None
        })
        return _obj
