...
class AllocationInnerSector(BaseModel):
    """
    portfolio allocation by sector
    """ # noqa: E501
    long: Optional[AllocationInnerSectorLong] = None
    short: Optional[AllocationInnerSectorShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "long": AllocationInnerSectorLong.from_dict(obj["long"]) if obj.get("long") is not None else None,
            "short": AllocationInnerSectorShort.from_dict(obj["short"]) if obj.get("short") is not None else None
        })
        return _obj
