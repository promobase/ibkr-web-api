...
class FyiUnreadnumberGet200Response(BaseModel):
    """
    FyiUnreadnumberGet200Response
    """ # noqa: E501
    bn: Optional[StrictInt] = Field(default=None, description="unread number", alias="BN")
    __properties: ClassVar[List[str]] = ["BN"]
