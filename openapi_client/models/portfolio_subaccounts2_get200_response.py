...
class PortfolioSubaccounts2Get200Response(BaseModel):
    """
    PortfolioSubaccounts2Get200Response
    """ # noqa: E501
    metadata: Optional[PortfolioSubaccounts2Get200ResponseMetadata] = None
    subaccounts: Optional[List[PortfolioSubaccounts2Get200ResponseSubaccountsInner]] = None
    __properties: ClassVar[List[str]] = ["metadata", "subaccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": PortfolioSubaccounts2Get200ResponseMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "subaccounts": [PortfolioSubaccounts2Get200ResponseSubaccountsInner.from_dict(_item) for _item in obj["subaccounts"]] if obj.get("subaccounts") is not None else None
        })
        return _obj
