...
class IserverContractConidInfoAndRulesGet200ResponseRulesInner(BaseModel):
    """
    IserverContractConidInfoAndRulesGet200ResponseRulesInner
    """ # noqa: E501
    algo_eligible: Optional[StrictBool] = Field(default=None, description="Contract supports algo orders", alias="algoEligible")
